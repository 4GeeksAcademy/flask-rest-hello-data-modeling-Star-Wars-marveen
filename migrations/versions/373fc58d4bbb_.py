...
Revision ID: 373fc58d4bbb
Revises: a5cffa318ac2
Create Date: 2026-04-21 14:29:43.294759
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('IMAGE', 'VIDEO', 'REEL', name='mediatype'), nullable=False),
